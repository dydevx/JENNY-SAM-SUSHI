...
const replaceCategory=(name,items)=>{const i=menu.findIndex(x=>x[0]===name);if(i>=0)menu[i]=[name,items]};
const specialDescriptions={400:'Echtes Krebsfleisch, Avocado, umwickelt mit Lachs, Butterfisch, Thunfisch',401:'Panierte Garnelen, Gurke, Frischkäse, umwickelt mit Aal',402:'Panierte Garnele, Gurke, Frischkäse, umwickelt mit Avocado',403:'Omelett, Avocado, Surimi, Frischkäse, umwickelt mit Garnelen',405:'Lachshaut, Avocado, Gurke, Frischkäse, Aal, umwickelt mit Lachs',406:'Lachs, Avocado, Gurke, Frischkäse, umwickelt mit Avocado',407:'Lachs, Avocado, Gurke, Frischkäse, umwickelt mit Ei',408:'Garnelen, Avocado, Gurke, Frischkäse, umwickelt mit Lachs und Thunfisch',409:'Gekochter Thunfisch, Mayo, Lauch, Chili, Gurke, umwickelt mit Röstzwiebeln',410:'Panierter Lachs, Frischkäse, Gurke, umwickelt mit Garnelen',411:'Gurke, umwickelt mit Lachs',412:'Gekochter Thunfisch, Mayonnaise, Lauch, Chili, Gurke, umwickelt mit Gurken',413:'Lachs, Avocado, Gurke, Frischkäse, umwickelt mit Aal',414:'Paniertes Gemüse, Frischkäse, umwickelt mit Lachs',417:'Lachs, Avocado, Gurke, Frischkäse, umwickelt mit Lachs und Avocado',418:'Scharfer Thunfisch, Gurke, umwickelt mit Thunfisch und Avocado',419:'Rettich, Kürbis, Avocado, Frischkäse, umwickelt mit Avocado',420:'Panierter Sushireis mit gekochtem Thunfisch, Lauch, Chili, Mayo',421:'Panierter Sushireis mit gehacktem Lachs, Mayo',422:'Panierter Sushireis mit Krebsfleisch, Mayo, Lauch',423:'Paniertes Gemüse, Frischkäse, umwickelt mit flambiertem Thunfisch',424:'Paniertes Gemüse, Frischkäse, umwickelt mit flambiertem Lachs',425:'Panierte Garnelen, Frischkäse, Gurken, umwickelt mit flambiertem Lachs und Thunfisch'};
const special=menu.find(x=>x[0].startsWith('Special Rolls'));
special[1]=special[1].flatMap(d=>{const m=d[2].match(/8 Stück:\s*([\d,]+)/);d[2]=specialDescriptions[d[0]];if(!m)return[d];const nr=d[0],name=d[1];return[[`${nr}~4 Stück`,`${name} · 4 Stück`,d[2],d[3],d[4]],[`${nr}~8 Stück`,`${name} · 8 Stück`,d[2],d[3],Number(m[1].replace(',','.'))]]});
const sashimi=menu.find(x=>x[0]==='Sashimi');
sashimi[1]=sashimi[1].map(d=>{const m=d[0].match(/^(\d+) \(([^)]+)\)$/)||d[0].match(/^(\d+) (Klein|Groß)$/);return m?[`${m[1]}~${m[2]}`,`${d[1]} · ${m[2]}`,d[2],d[3],d[4]]:d});
replaceCategory('Pho Hanoi',rows(`580|GEDÄMPFTE HÄHNCHENBRUST||13.9|Traditionelle Reisbandnudelsuppe mit Ingwer und Kräutern
581|MARINIERTES RINDFLEISCH||14.9|Traditionelle Reisbandnudelsuppe mit Ingwer und Kräutern
582|GEBACKENER TOFU|6|11.9|Traditionelle Reisbandnudelsuppe mit Ingwer und Kräutern
583|RINDFLEISCH & HÄHNCHENBRUST||14.9|Traditionelle Reisbandnudelsuppe mit Ingwer und Kräutern
584|GEGRILLTES HÄHNCHENBRUSTFILET||13.9|Traditionelle Reisbandnudelsuppe mit Ingwer und Kräutern`));
replaceCategory('Udon-Suppe',rows(`590|ENTE KROSS|1|15.9|Japanische Nudeln, Hühnerbrühe, Pak Choi und Kräuter
591|HÄHNCHENBRUSTFILET||13.9|Japanische Nudeln, Hühnerbrühe, Pak Choi und Kräuter
592|TOFU|6|11.9|Japanische Nudeln, Hühnerbrühe, Pak Choi und Kräuter
593|MARINIERTES RINDFLEISCH||14.9|Japanische Nudeln, Hühnerbrühe, Pak Choi und Kräuter
594|GARNELEN|2|14.9|Japanische Nudeln, Hühnerbrühe, Pak Choi und Kräuter
595|GEGRILLTES HÄHNCHENBRUSTFILET|1|14.9|Japanische Nudeln, Hühnerbrühe, Pak Choi und Kräuter`));
...
replaceCategory('Poke Bowls',rows(`490|BUDDA POKE BOWL||11.9|Mit Tofu
491|YAKITORY POKE BOWL||12.9|Mit süßem Huhn am Spieß
492|BEEF POKE BOWL||13.5|Mit mariniertem Rindfleisch
493|CRISPY CHICKEN POKE BOWL||13.5|Mit paniertem Hähnchen
494|GRILL CHICKEN POKE BOWL||13.5|Mit gegrilltem Hähnchenbrustfilet
495|SAKE POKE BOWL||13.9|Mit rohem Lachs
496~Tuna|TUNA POKE BOWL||15.9|Mit rohem Thunfisch
496~Sashimi|SASHIMI POKE BOWL||15.9|Mit verschiedenen rohen Fischsorten`));
replaceCategory('Desserts',rows(`620|DRAGON BALL||4.0|4 Stück, gefüllt mit süßen Bohnen
621|MOCHI||4.0|Reiskuchen mit roten Bohnen
